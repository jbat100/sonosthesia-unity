...
namespace Sonosthesia
{
    ...
    public class BaseColorModifier<TRepresentation> : BaseModifier<TRepresentation> where TRepresentation : class
    {
        public IColorAccessor<TRepresentation> colorAccessor;
